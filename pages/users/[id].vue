<template>
    ...
    <div class="q-pa-md">
        ...
        >
            ...
            <template #top>
                <div class ="col-3 text-h4 text-blue">User List </div>
                <q-space /> 
...
<script setup lang="ts">
    ...
    async function onRequest(props:any){
        ...
        loading.value = true
        const {data:dataTable} = await $fetch('/api/user/v1.0.0/listByPagination',{
            method:'POST',
            body: {
    ...
    async function getRowsNumberCount(filter:any){
        ...
        const {data:rowsCount} = await useFetch('/api/user/v1.0.0/recordsCount',{
            query:{
