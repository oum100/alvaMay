  ...
  export default {
    setup () {
      ...
      function fetchFromServer (startRow, count, filter, sortBy, descending) {
        console.log("FromServer-sortBy: ",sortBy)
        console.log("FromServer-descending: ",descending)
        const data = filter
          ...
          const sortFn = sortBy === 'desc'
            ...
            : (descending
                ? (a, b) => (
                  ...
                  console.log("1.result",parseFloat(b[ sortBy ]), parseFloat(a[ sortBy ]))
                )
                : (a, b) => (
                  // parseFloat(a[ sortBy ]) - parseFloat(b[ sortBy ])
                  console.log("2.result",parseFloat(a[ sortBy ]), parseFloat(b[ sortBy ]))
                )
              )
          data.sort(sortFn)
        }
        console.log("After Data: ",data)
        // console.log("strtRow",startRow,count)
